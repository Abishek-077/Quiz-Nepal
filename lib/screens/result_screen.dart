...
class _ResultScreenState extends State<ResultScreen> {
  ...
  void _shareScore() {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
          content: Text(
              'Share placeholder: I scored ${widget.result.score} in Quiz Battle Nepal!')),
    );
  }
        ...
        children: [
            ...
            child: Column(
              children: [
                const Icon(Icons.emoji_events,
                    color: AppColors.accent, size: 74),
          ...
          if (!_coinsDoubled)
            OutlinedButton.icon(
              ...
              label: Text(_isRewarding
                  ? 'Unlocking reward...'
                  : 'Double coins with mock rewarded ad'),
            ),
          const SizedBox(height: 10),
          ElevatedButton.icon(
